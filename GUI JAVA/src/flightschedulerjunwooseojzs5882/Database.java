...
public class Database {
    ...
    public Database()
    {
        try{
            ...
            selectAllDate = connection.prepareStatement("SELECT * FROM App.DATE");
            ...
            selectAllFlight = connection.prepareStatement("SELECT * FROM app.FLIGHT");
    ...
    public int getMaxSeats(String flightID){
        createConnection();
        try {
            seatstuff = connection.prepareStatement("SELECT * FROM app.FLIGHT");
    ...
    public void addFlight(String flightID, int maxSeats) {
        createConnection();
        String sql = "insert into app.FLIGHT(FLIGHT, SEAT) VALUES(?,?)";
    ...
    void deleteFlight(String flightID) {
        createConnection();
        String sql = "DELETE from app.FLIGHT where FLIGHT = ?";
