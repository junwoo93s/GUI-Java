 ...
 * @author junwooseo
 */
public class flightschedulerjunwooseojzs5882 extends javax.swing.JFrame implements ActionListener {

    private Database database;
    private Booking_Q booking;
    
    public flightschedulerjunwooseojzs5882() {
        initComponents();
        booking = new Booking_Q();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("JUNWOO SEO REVERATION SYSTEM");
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == BookingFlightButton) {
            flightschedulerjunwooseojzs5882.this.BookingFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CheckStatusButton) {
            flightschedulerjunwooseojzs5882.this.CheckStatusButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CheckWaitListButton) {
            flightschedulerjunwooseojzs5882.this.CheckWaitListButtonActionPerformed(evt);
        }
        else if (evt.getSource() == CancelFlightButton) {
            flightschedulerjunwooseojzs5882.this.CancelFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == customerStatusCheckButton) {
            flightschedulerjunwooseojzs5882.this.customerStatusCheckButtonActionPerformed(evt);
        }
        else if (evt.getSource() == MonthComboBox) {
            flightschedulerjunwooseojzs5882.this.MonthComboBoxActionPerformed(evt);
        }
        else if (evt.getSource() == AddingDateButton) {
            flightschedulerjunwooseojzs5882.this.AddingDateButtonActionPerformed(evt);
        }
        else if (evt.getSource() == newFlightButton) {
            flightschedulerjunwooseojzs5882.this.newFlightButtonActionPerformed(evt);
        }
        else if (evt.getSource() == droppingFlightButton) {
            flightschedulerjunwooseojzs5882.this.droppingFlightButtonActionPerformed(evt);
        }
    }// </editor-fold>//GEN-END:initComponents

    private void BookingFlightButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BookingFlightButtonActionPerformed
        //event handling
    ...
    }//GEN-LAST:event_BookingFlightButtonActionPerformed
    ...
    private void CheckWaitListButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckWaitListButtonActionPerformed
        // check the waitlist for the flight on that day
        String date = date_for_bookingComboBox.getSelectedItem().toString();
        String flightID = flight_for_booking_ComboBox.getSelectedItem().toString();
    ...
    private void CancelFlightButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelFlightButtonActionPerformed
        // drops the customer from the flight
        String name = customerField.getText();
        String date = date_for_bookingComboBox.getSelectedItem().toString();
        String flightID = flight_for_booking_ComboBox.getSelectedItem().toString();
    ...
    private void customerStatusCheckButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customerStatusCheckButtonActionPerformed
        // Checks the customer's booked and waitlisted flights
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(flightschedulerjunwooseojzs5882.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new flightschedulerjunwooseojzs5882().setVisible(true);
            }
        });
    }
